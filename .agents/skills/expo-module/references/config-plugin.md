...
Config plugins customize native Android and iOS projects generated with `npx expo prebuild`. They are synchronous
functions that accept an `ExpoConfig` and return a modified version.
