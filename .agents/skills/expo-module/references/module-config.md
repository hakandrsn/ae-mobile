...
Expo autolinking automatically discovers and links modules that have `expo-module.config.json`. No manual native project
configuration needed — install via npm, run `pod install`.
